...
<template>
    <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none"
        ...
        <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11 lg:justify-end">
                ...
                <button
                    ...
                    <span class="relative block h-5.5 w-5.5 cursor-pointer">
                        <span class="du-block absolute right-0 h-full w-full">
                            <span
                                class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black duration-200 ease-in-out dark:bg-white"
                                :class="{ '!w-full': sidebarState == false }"></span>
                            <span
                                class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black duration-200 ease-in-out dark:bg-white"
                                :class="{ '!w-full': sidebarState == false }"></span>
                            <span
                        ...
                        <span class="du-block absolute right-0 h-full w-full rotate-45">
                            <span
                                ...
                                :class="{ '!h-0 delay-[0]': sidebarState == false }"></span>
                            <span
                                class="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white"
                                :class="{ '!h-0 dealy-200': sidebarState == false }"></span>
                        </span>
                    </span>
                </button>
            ...
            <div class="flex items-center gap-3 2xsm:gap-7">
                ...
                <!-- User Area -->
                <div class="relative">
                    <a class="flex items-center gap-1" href="#" @click.stop.prevent="dropdownOpen = !dropdownOpen">
